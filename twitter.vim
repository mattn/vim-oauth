...
let [request_token, request_token_secret] = oauth#request_token(request_token_url, consumer_key, consumer_secret)
...
let [access_token, access_token_secret] = oauth#access_token(access_token_url, consumer_key, consumer_secret, request_token, request_token_secret, {"oauth_verifier": verifier})
